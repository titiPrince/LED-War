...
function main() {
    ...
    if (move === 0 && data.me.canGoUp()) return data.me.goUp;
    if (move === 1 && data.me.canGoDown()) return data.me.goDown;
    if (move === 2 && data.me.canGoLeft()) return data.me.goLeft;
    if (move === 3 && data.me.canGoRight()) return data.me.goRight;
